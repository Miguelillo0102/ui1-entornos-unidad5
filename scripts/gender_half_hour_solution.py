...
gender_trips_stream = bike_time_stream.filter(expr('gender>0'))
grouped_stream=gender_trips_stream.groupBy(window(bike_time_stream.time,'30 minutes'), 'gender').count()
